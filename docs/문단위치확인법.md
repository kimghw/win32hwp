...
```python
from cursor import get_current_pos, get_hwp_instance
...
### 로컬 API 문서
- `/mnt/d/hwp_docs/win32/HwpAutomation_2504_part02.md` - MovePos 상세
- `/mnt/d/hwp_docs/win32/HwpAutomation_2504_part03.md` - GetPos, SetPos, KeyIndicator
- `/mnt/d/hwp_docs/win32/ActionTable_2504_part03.md` - Move* 액션 테이블
- `/mnt/d/hwp_docs/win32/ParameterSetTable_2504_part09.md` - ListParaPos ParameterSet
